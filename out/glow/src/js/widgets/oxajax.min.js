    ...
    oxAjax = {
        loadingScreen: {
            start: function (a, b) {
                ...
                return $(a).each(function () {
                    ...
                    if (a.innerHTML = '<div class="loadingfade"></div><div class="loadingicon"></div><div class="loadingiconbg"></div>', $("div", a).css({
                        ...
                        var d = Math.round(b.offset().left - 10 - $(this).offset().left + b.width() / 2), e = b.offset().top, f = Math.round(e - 10 - $(this).offset().top + (b.last().offset().top - e + b.last().height()) / 2);
            ...
            "FORM" == a[0].tagName ? ($("input", a).each(function () {
                return "checkbox" != this.type || this.checked ? void(d[this.name] = this.value) : !0
            ...
            b.targetEl && (j = c.loadingScreen.start(b.targetEl, b.iconPosEl)), f || (f = "get"), jQuery.ajax({
                data: g, url: e, type: f, timeout: 3e4, beforeSend: function (a, b) {
                    b.url = b.url.replace("&&", "&")

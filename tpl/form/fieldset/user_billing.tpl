...
<div class="form-group">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxsal)}] req[{/if}]" for="invadr_oxuser__oxfname">[{oxmultilang ident="TITLE"}]</label>
...
<div class="form-group[{if $aErrors.oxuser__oxfname}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxfname)}] req[{/if}]">[{oxmultilang ident="FIRST_NAME"}]</label>
    <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxlname}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxlname)}] req[{/if}]">[{oxmultilang ident="LAST_NAME"}]</label>
    <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxcompany}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxcompany)}] req[{/if}]">[{oxmultilang ident="COMPANY"}]</label>
    <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxaddinfo}] text-danger[{/if}]">
    ...
    <label [{if $_address_addinfo_tooltip}]title="[{$_address_addinfo_tooltip}]"[{/if}] class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxaddinfo)}] req[{/if}][{if $_address_addinfo_tooltip}] tooltip[{/if}]">[{oxmultilang ident="ADDITIONAL_INFO"}]</label>
    <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxstreet}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxstreet) || $oView->isFieldRequired(oxuser__oxstreetnr)}] req[{/if}]">[{oxmultilang ident="STREET_AND_STREETNO"}]</label>
...
<div class="form-group[{if $aErrors.oxuser__oxzip}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxzip) || $oView->isFieldRequired(oxuser__oxcity)}] req[{/if}]">[{oxmultilang ident="POSTAL_CODE_AND_CITY"}]</label>
    <div class="clear display-xs-block"></div>
...
<div class="form-group[{if $aErrors.oxuser__oxustid}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxustid)}] req[{/if}]">[{oxmultilang ident="VAT_ID_NUMBER"}]</label>
    <div class="col-sm-9 col-md-8">
...
[{block name="form_user_billing_country"}]
    <div class="form-group[{if $aErrors.oxuser__oxcountryid}] text-danger[{/if}]">
        <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxcountryid)}] req[{/if}]">[{oxmultilang ident="COUNTRY"}]</label>
        <div class="col-sm-9 col-md-8">
    ...
    <div class="form-group">
        <label class="control-label col-sm-3 col-md-4" for="[{$oxcmp_user->oxuser__oxstateid->value}]">[{oxmultilang ident="DD_USER_BILLING_LABEL_STATE"}]</label>
        <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxfon}] text-danger"[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxfon)}] req[{/if}]">[{oxmultilang ident="PHONE"}]</label>
    <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxfax}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxfax)}] req[{/if}]">[{oxmultilang ident="FAX"}]</label>
    <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxmobfon}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxmobfon)}] req[{/if}]">[{oxmultilang ident="CELLUAR_PHONE"}]</label>
    <div class="col-sm-9 col-md-8">
...
<div class="form-group[{if $aErrors.oxuser__oxprivfon}] text-danger[{/if}]">
    <label class="control-label col-sm-3 col-md-4[{if $oView->isFieldRequired(oxuser__oxprivfon)}] req[{/if}]">[{oxmultilang ident="PERSONAL_PHONE"}]</label>
    <div class="col-sm-9 col-md-8">

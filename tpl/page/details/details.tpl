...
[{else}]
   ...
   <div id="details_container">
      <div id="details">
         ...
         <div class="row" id="detailsItemsPager">
            <div class="col-xs-4 text-left pager-prev">
               [{if $actCategory->prevProductLink}]
                  <i class="fa fa-angle-left"></i>
                  <a id="linkPrevArticle" class="" href="[{$actCategory->prevProductLink}]">[{oxmultilang ident="PREVIOUS_PRODUCT"}]</a>
               [{/if}]
            </div>
            ...
            <div class="col-xs-4 text-right pager-next">
               [{if $actCategory->nextProductLink}]
                  <a id="linkNextArticle" href="[{$actCategory->nextProductLink}]">[{oxmultilang ident="NEXT_PRODUCT"}]</a>

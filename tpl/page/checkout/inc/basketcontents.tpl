                ...
                [{block name="checkout_basketcontents_basketitem"}]
                    ...
                    <div class="col-xs-9 col-sm-5 col-md-5">
                        [{block name="checkout_basketcontents_basketitem_titlenumber"}]
                            ...
                            <b>[{$oArticle->oxarticles__oxtitle->value}]</b>
                            [{if $editable}]</a>[{/if}]
                            ...
                            [{foreach from='|'|explode:$oArticle->oxarticles__oxvarname->value key="_i" item="_vname"}]
                                <div>
                                    <b>[{$_vname}]:</b> [{if $aVarselect[$_i]|is_numeric  && $aVarselect[$_i]|intval == $aVarselect[$_i]}][{$aVarselect[$_i]|number_format:0:',':'.'}][{else}][{$aVarselect[$_i]}][{/if}]
                                </div>
                            [{/foreach}]
                                            ...
                                            [{else}]
                                                ...
                                                [{if $oActiveSelection}]
                                                    <div>
                                                        ...
                                                        <b>[{$oList->getLabel()}]:</b> [{$oActiveSelection->getName()}]
                                                    </div>
                                                [{/if}]
                                            [{/if}]
                                        [{/foreach}]

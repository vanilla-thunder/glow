        ...
        [{block name="checkout_order_details"}]
            ...
            [{else}]
                ...
                [{block name="shippingAndPayment"}]
                    <div class="row">
                        <div class="col-xs-12 col-sm-6" id="orderShipping">
                            <form action="[{$oViewConf->getSslSelfLink()}]" method="post">
                                <div class="hidden">
                                    [{$oViewConf->getHiddenSid()}]
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">
                                            ...
                                            [{if !$smarty.cookies.shipsetscount || $smarty.cookies.shipsetscount > 1}]
                                                <button type="submit" class="btn btn-xs btn-warning pull-right submitButton largeButton" title="[{oxmultilang ident="EDIT"}]">
                                                    <i class="fa fa-pencil"></i>
                                                </button>
                                            [{/if}]
                        ...
                        <div class="col-xs-12 col-sm-6" id="orderPayment">
                            <form action="[{$oViewConf->getSslSelfLink()}]" method="post">
                                <div class="hidden">
                                    [{$oViewConf->getHiddenSid()}]
                                    <input type="hidden" name="cl" value="payment">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">
                                            ...
                                            [{if !$smarty.cookies.paymentscount || $smarty.cookies.paymentscount > 1}]
                                                <button type="submit" class="btn btn-xs btn-warning pull-right submitButton largeButton" title="[{oxmultilang ident="EDIT"}]">
                                                    <i class="fa fa-pencil"></i>
                                                </button>
                                            [{/if}]

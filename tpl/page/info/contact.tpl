               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_mac" name="c_mac" required
               ...
               <div class="col-sm-offset-4 col-sm-8">
                  ...
                  [{oxifcontent ident="oxsecurityinfo" object="oCont"}]
                     <p class="alert alert-info">
                        [{oxmultilang ident="GLOW_CONTACT_SECURITY"}] <a data-fancybox-href="[{$oCont->getLink()}]?plain=1" href="[{$oCont->getLink()}]" class="ajax" target="_blank" rel="nofollow">[{$oCont->oxcontents__oxtitle->value}]</a>
                     </p>
                  [{/oxifcontent}]

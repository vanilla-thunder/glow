  ...
  <tr>
    <td style="text-align: lenter; vertical-align: top; padding: 15px;">
                                 [{block name="email_html_order_cust_username"}]
                                    <strong style="margin: 10px 0;">[{oxmultilang ident="EMAIL_ADDRESS" suffix="COLON" }]</strong><br>
                                 ...
                                 [{block name="email_html_order_cust_paymentinfo_top"}]
                                    [{if $payment->oxuserpayments__oxpaymentsid->value != "oxempty"}]
                                       <strong style="margin: 10px 0;">[{oxmultilang ident="PAYMENT_METHOD" suffix="COLON" }]</strong><br>
                                 ...
                                 [{block name="email_html_order_cust_deliveryinfo"}]
                                    [{if $payment->oxuserpayments__oxpaymentsid->value != "oxempty"}]
                                       <strong style="margin: 10px 0;">[{oxmultilang ident="SELECTED_SHIPPING_CARRIER" suffix="COLON" }]</strong><br>
                                       [{ $order->oDelSet->oxdeliveryset__oxtitle->value }]
                                       <br>
                                    [{/if}]
                                 [{/block}]
    </td><td style="text-align: lenter; vertical-align: top; padding: 15px;" width="50%">
                ...
                [{if $payment->oxuserpayments__oxpaymentsid->value != "oxempty"}]
                    ...
                    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                        ...
                        Referenztext: <b>[{$order->oxorder__oxtransid->value}]</b>
                        [{ elseif $order->oxorder__psamazonorderid->value }]
                        Referenztext: <b>[{$order->oxorder__psamazonorderid->value}]</b>
                        [{ elseif $order->oxorder__jagamazonorderreferenceid->value }]
                        Referenztext: <b>[{$order->oxorder__jagamazonorderreferenceid->value}]</b>
                        [{ elseif $order->oxorder__bztransaction->value }]
                        Referenztext: <b>[{$order->oxorder__bztransaction->value}]</b>
                        [{/if}]
                    </p>
                [{/if}]
                [{/block}]
    </td></tr><tr><td style="text-align: lenter; vertical-align: top; padding: 15px;">
[{* RECHUNGSADRESSE *}]
    ...
    </td><td style="text-align: lenter; vertical-align: top; padding: 15px;">
[{* abweichende Lieferanschrift *}]
                                 [{if $order->oxorder__oxdellname->value }]
                                    <strong style="margin: 10px 0;">[{oxmultilang ident="SHIPPING_ADDRESS" suffix="COLON" }]</strong><br>
                                 ...
                                 [{/if}]
    </td></tr><tr><td style="text-align: lenter; vertical-align: top; padding: 15px;" colspan="2">
                ...
                [{foreach key=basketindex from=$basket->getContents() item=basketitem}]
                    [{block name="email_html_order_owner_basketitem"}]
                        ...
                        <tr valign="top">
                            ...
                            <td valign="top" align="right"><b>[{oxprice price=$basketitem->getPrice() currency=$currency}]</b><br/><small>([{$basketitem->getVatPercent() }]% MwSt)</small></td>
                        </tr>
                    [{/block}]
                [{/foreach}]
            </table>
...
[{* Zusammenfassung der Kosten *}]
                                 ...
                                 <table border="0" cellspacing="0" cellpadding="0" width="300">
                                    ...
                                    [{block name="email_html_order_cust_ts"}]
                                       ...
                                       [{if $trustedShopProtectionCost && $trustedShopProtectionCost->getPrice() > 0  }]
                                          <tr valign="top">
                                             <td>[{oxmultilang ident="TRUSTED_SHOP_BUYER_PROTECTION" suffix="COLON" }]</td>
                                             <td align="right">[{oxprice price=$trustedShopProtectionCost->getNettoPrice() currency=$currency}]</td>
                                          </tr>
                                          [{if $trustedShopProtectionCost->getVatValue()}]
                                             <tr valign="top">
                                                ...
                                                <td align="right">[{oxprice price=$trustedShopProtectionCost->getVatValue() currency=$currency}]</td>
                                             </tr>
                                          [{/if}]
                                          <tr><td colspan="2"><hr></td></tr>
                                       [{/if}]
      ...
      [{* mitteilung an uns und download links *}]
                                 ...
                                 [{block name="email_html_order_cust_userremark"}]
                                    [{if $order->oxorder__oxremark->value }]
                                       <strong style="margin: 10px 0;">[{oxmultilang ident="WHAT_I_WANTED_TO_SAY" SUFFIX="COLON" }]</strong><br>
                                 ...
                                 [{block name="email_html_order_cust_download_link"}]
                                    [{if $oOrderFileList and $oOrderFileList|count }]
                                       <strong style="margin: 10px 0;">[{oxmultilang ident="MY_DOWNLOADS_DESC" }]</strong><br>
  ...
  <tr><td style="text-align: lenter; vertical-align: top; padding: 15px;" colspan="2">
                                 [{block name="email_html_order_cust_tsinfo"}]
                                    [{if $oViewConf->showTs("ORDEREMAIL") && $oViewConf->getTsId() }]
                                       ...
                                       <strong style="margin: 10px 0;">[{oxmultilang ident="RATE_OUR_SHOP" }]</strong><br>

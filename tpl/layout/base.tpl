...
[{if $oViewConf->getViewThemeParam('blUseBackground')}]
   ...
   [{assign var="sBackgroundUrl"           value=$oViewConf->getPictureDir()|cat:"wysiwigpro/`$sBackgroundPath`"}]
...
[{block name="base_js"}]
   ...
   [{oxscript include="libs/bootstrap-validator/dist/validator.min.js" priority=3}]
   [{oxscript include="libs/jquery-unveil/jquery.unveil.js" priority=3}]
   [{oxscript include="libs/matchheight/jquery.matchHeight-min.js" priority=3}]
   [{oxscript include="libs/flexslider/jquery.flexslider-min.js" priority=3}]
   [{oxscript include="libs/fancyBox/lib/jquery.mousewheel-3.0.6.pack.js" priority=3}]
